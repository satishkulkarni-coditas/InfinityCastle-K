    ...
    <mat-sidenav-container class="sidenav-container">
      <mat-sidenav mode="side" opened class="sidenav" [class.sidenav-collapsed]="!isExpanded">
        ...
        <mat-nav-list>
          ...
          <a mat-list-item routerLink="/users" routerLinkActive="active" *ngIf="authService.hasRole('Admin') || authService.hasRole('EntityAdmin')">
            <mat-icon>people</mat-icon>
            <span *ngIf="isExpanded">Manage Users</span>
          </a>
          
          <a mat-list-item routerLink="/users/assign" routerLinkActive="active" *ngIf="authService.hasRole('Admin')">

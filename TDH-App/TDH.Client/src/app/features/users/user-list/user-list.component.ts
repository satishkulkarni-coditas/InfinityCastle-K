    ...
    <div class="container">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        ...
        <div style="display: flex; gap: 10px;">
          <button mat-raised-button color="primary" (click)="showCreateForm = !showCreateForm" *ngIf="authService.hasRole('Admin') || authService.hasRole('EntityAdmin')">
      ...
      <mat-card *ngIf="showCreateForm && (authService.hasRole('Admin') || authService.hasRole('EntityAdmin'))" style="margin-bottom: 20px;">
        <mat-card-header>
      ...
      <mat-card *ngIf="editingUser && (authService.hasRole('Admin') || authService.hasRole('EntityAdmin'))" style="margin-bottom: 20px;">
        <mat-card-header>
      ...
      <mat-card>
        <table mat-table [dataSource]="users" class="mat-elevation-z0">
          ...
          <ng-container matColumnDef="actions">
            ...
            <td mat-cell *matCellDef="let user">
              <button mat-icon-button color="primary" (click)="editUser(user)" *ngIf="authService.hasRole('Admin') || authService.hasRole('EntityAdmin')" title="Edit">
                <mat-icon>edit</mat-icon>
              </button>
              <button mat-icon-button color="warn" (click)="deleteUser(user.id)" *ngIf="authService.hasRole('Admin')" title="Delete">

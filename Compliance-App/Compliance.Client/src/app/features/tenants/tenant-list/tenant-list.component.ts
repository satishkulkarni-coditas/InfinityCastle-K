  ...
  template: `
    <div class="container">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <h1>Tenants</h1>
        <button mat-raised-button color="primary" routerLink="/tenants/onboard" *ngIf="authService.hasRole('AppAdmin')">
        ...
        <table mat-table [dataSource]="tenants" class="mat-elevation-z0">
          ...
          <ng-container matColumnDef="actions">
            ...
            <td mat-cell *matCellDef="let tenant">
              <button mat-icon-button color="primary" (click)="editTenant(tenant); $event.stopPropagation()" *ngIf="authService.hasRole('AppAdmin')" title="Edit">
                <mat-icon>edit</mat-icon>
              </button>
              <button mat-icon-button color="warn" (click)="deleteTenant(tenant.id); $event.stopPropagation()" *ngIf="authService.hasRole('AppAdmin')" title="Delete">
